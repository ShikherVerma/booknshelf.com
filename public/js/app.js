...
},{"./xhr":35}],34:[function(require,module,exports){
/**
 * JSONP client.
 */
...
},{"../promise":49}],35:[function(require,module,exports){
/**
 * XMLHttp client.
 */
...
},{"../promise":49}],36:[function(require,module,exports){
/**
...
},{"./client/default":33,"./interceptor":41,"./interceptor/before":38,"./interceptor/cors":39,"./interceptor/header":40,"./interceptor/jsonp":42,"./interceptor/method":43,"./interceptor/mime":44,"./interceptor/timeout":45,"./promise":49}],37:[function(require,module,exports){
/**
 * Install plugin.
 */
...
},{"./http":36,"./lib/util":48,"./promise":49,"./resource":50,"./url":51}],38:[function(require,module,exports){
/**
 * Before Interceptor.
 */
...
},{"../client/jsonp":34}],40:[function(require,module,exports){
/**
 * Header Interceptor.
 */
...
},{"../promise":49}],42:[function(require,module,exports){
/**
 * JSONP Interceptor.
 */
...
},{"../client/jsonp":34}],43:[function(require,module,exports){
/**
...
},{"./lib/promise":46}],50:[function(require,module,exports){
/**
...
},{"./lib/url-template":47}],52:[function(require,module,exports){
...
},{"./app-bootstrap":53,"./booknshelf":55,"./components/bootstrap":60}],55:[function(require,module,exports){
'use strict';
...
Vue.component('app-book-item-save-modal', {
    ...
    methods: {
        ...
        storeBookToNewBookshelf: function storeBookToNewBookshelf() {
            ...
            App.post('/shelves', this.form).then(function (response) {
                var shelfId = response.id;
                _this2.form.name = '';
                // add the book to the new shelf
                _this2.storeBookToShelf(shelfId);
                _this2.success = true;
            });
        },
...
},{"./activity":56,"./book/book-item":58,"./book/book-item-save-modal":57,"./book/books":59,"./home":61,"./navbar":62,"./new-shelf-modal":63,"./notifications":64,"./please-login-modal.js":65,"./profile":66,"./profile/profile-all-shelves":67,"./profile/profile-header":68,"./profile/profile-shelf-item":69,"./search/book-search-bar":70,"./settings":71,"./shelf/shelf-book-item.js":72,"./shelf/shelf-search-bar.js":73,"./shelf/shelf.js":74,"./update-profile-information":76,"./update-profile-photo":77}],61:[function(require,module,exports){
'use strict';
...
Vue.component('home', {
    ...
    methods: {
        ...
        create: function create() {
            ...
            App.post('/api/task', this.form).then(function (task) {
...
Vue.component('app-please-login-modal', {
    ...
    events: {
        showPleaseLoginModal: function showPleaseLoginModal() {
            this.show = true;
        }
    },
...
},{"./tab-state":75}],72:[function(require,module,exports){
'use strict';
...
Vue.component('app-shelf-book-item', {
    ...
    methods: {
        ...
        removeBookFromShelf: function removeBookFromShelf() {
            var _this = this;
...
Vue.component('app-shelf-search-bar', {
    ...
    ready: function ready() {
        ...
        var templateDropdown = Hogan.compile('<div class="left-container">' + '<div class="aa-dataset-user"></div>' + '</div>' + '<div class="right-container">' + '<div class="aa-dataset-shelf"></div>' + '</div>');
        ...
        autocomplete('#algolia-search', {
            ...
            templates: {
                ...
                suggestion: function suggestion(_suggestion) {
                    return '<h5>' + _suggestion._highlightResult.name.value + '</h5>';
                }
            },
            displayKey: 'name',
            name: 'user'
            ...
            templates: {
                ...
                suggestion: function suggestion(_suggestion2) {
                    return '<h5>' + _suggestion2._highlightResult.name.value + '</h5>';
                }
            },
            displayKey: 'name',
            name: 'shelf'
...
Vue.component('app-shelf', {
    ...
    methods: {
        getBooks: function getBooks() {
            var shelfId = this.shelf.id;
            this.$http.get('/shelves/' + shelfId + '/books').then(function (response) {
