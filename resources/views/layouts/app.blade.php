...
<head>
    ...
    <meta property="og:image" content="{{ $ogImage or '/img/social/homepage-screenshot-social-main.png' }}"/>
    ...
    <meta name="twitter:image"
          content="{{ $ogImage or '/img/social/homepage-screenshot-social-main.png' }}">
