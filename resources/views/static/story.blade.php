    ...
    <section class="hero is-medium home-search-bg"
        ...
        <div class="hero-body">
            <div class="container has-text-centered">
                <h3 class="title is-3" style="color: white;">
                    Follow my story of making Booknshelf into a profitable online business 💰.
                </h3>
                                ...
                                <div class="control is-grouped">
                                    ...
                                    <div class="control">
                                        <input type="submit" value="Subscribe" name="subscribe"
                                               id="mc-embedded-subscribe" class="button is-white is-large is-outlined">
                                    </div>
                                </div>
